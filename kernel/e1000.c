...
e1000_recv(void)
{
  ...
  // For the e1000_recv call is made by device interrupt,
  // and will call e1000_transmit in net_rx(),
  // so it would not need a lock.
  // If lock, it may cause a deadlock
